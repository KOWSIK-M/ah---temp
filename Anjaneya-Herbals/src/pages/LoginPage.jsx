      ...
      >
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-brand-sand">
          ...
          <div className="text-center mb-8">
            <Link
              to="/"
              className="inline-flex items-center text-brand-moss hover:text-brand-earth mb-4 transition-colors"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="flex justify-end mt-2">
                <Link
                  to="/forgot-password"
                  className="text-sm text-brand-terracotta hover:text-brand-earth font-medium"
                >
                  Forgot password?
                </Link>
              </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600">
              ...
              <Link
                to="/register"
                className="text-brand-terracotta hover:text-brand-earth font-medium"
              >
                Sign up
              </Link>
            </p>
